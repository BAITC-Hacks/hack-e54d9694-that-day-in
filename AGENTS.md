...
- `codex/contracts` was migrated to the authoritative dataset in c4b8ca1 and integrated into `codex/ui`. The older `codex/dataset-prep` catalog still describes the superseded six-district/80:20 plan; do not adopt that catalog without migration.
